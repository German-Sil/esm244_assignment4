...
my_stop <- data.frame(word = c("de", "al", "mitsch", "gosselink", "john", "fig", "eds", "ed", "pp", "figure")) # list of words with no meaning in text such as author names, figure captions, and other similar abbreviations 
